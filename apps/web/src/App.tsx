...
export function App() {
  ...
  return (
    <main>
      ...
      <nav className="app-nav"><NavLink to="/">Inicio</NavLink><NavLink to="/projects">Proyectos</NavLink><NavLink to="/items/evaluation">Evaluación</NavLink><NavLink to="/documents/upload">Cargar PDFs</NavLink><NavLink to="/documents">Documentos</NavLink></nav>
